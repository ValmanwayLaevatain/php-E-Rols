<div class="breadcrumbs">
    ...
    <div class="card">
        <div class="card-header">
            <strong>Rekap</strong> Surat Masuk
        </div>
    <div class="card-body card-block">

 

<form action="index.php?page=masuk-tambah" method="post" enctype="multipart/form-data" class="form-horizontal">    
                
                        <button type="submit" class="btn btn-primary btn-sm" href= >
                          <i class="fa fa-plus"></i> Tambah Data </button>
<a href="../user/pdf_surat-masuk.php" class="btn btn-warning btn-sm">
...
while($row = mysqli_fetch_array($data,MYSQLI_ASSOC))
{
    ...
    $href = "index.php?page=masuk-edit&id=".$row['id'];
    $btn = "<a class='btn btn-primary' href='$href'><i class='fa fa-edit'></i></a>";
    echo "<td>".$btn;

    $href1 = "index.php?page=masuk-hapus-notif&id=".$row['id'];
    $btn1 = "<a class='btn btn-danger' href='$href1'><i class='fa fa-trash'></i></a>";
    echo $btn1;

    $href2 = "index.php?page=masuk-view&id=".$row['id'];

...
?>
        ...
        <div class="col-lg-12">
                        ...
                        <form action="index.php?page=masuk-edit-notif&id=<?php echo $id; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                          
                          <div class="card">
                            <div class="card-header">
                              <strong>Edit</strong> Surat Masuk
                            </div>
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-3"><input type="date" id="t_diterima" name="t_diterima" placeholder="YYYY-MM-DD" class="form-control" value="<?php echo $row['t_diterima']; ?>"></div>
                          </div>                          
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-5"><input type="text" id="alamat_pengirim" name="alamat_pengirim" placeholder="" class="form-control" value="<?php echo $row['alamat_pengirim']; ?>"></div>
                          </div>

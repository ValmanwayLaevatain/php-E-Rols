...
?>
    ...
    <div class="card-body card-block">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-5"><medium class="form-text text-muted">: <?php echo $row['t_diterima']; ?></medium></div>
                          </div>
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-5"><medium class="form-text text-muted">: <?php echo $row['alamat_pengirim']; ?></medium></div>
                          </div>

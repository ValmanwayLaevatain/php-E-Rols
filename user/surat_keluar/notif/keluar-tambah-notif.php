...
<?php
if (isset($_POST['no_surat']) AND isset($_POST['t_surat']) AND isset($_POST['perihal']) AND isset($_POST['isi_surat']) AND isset($_POST['alamat_tujuan']) AND isset($_POST['waktu']) AND isset($_POST['tempat']) AND isset($_POST['lampiran']) AND isset($_POST['keterangan']))
{
    include "../koneksi.php";
  ...
  if(empty($no_surat))
  {
                    ...
                    $not4 = "index.php?page=keluar-tambah";
                    $not5 = "";
                    $not6 = "Kembali";
                    $not7 = "alert-warning";
    ...
    else
  {
    if(empty($alamat_tujuan))
    {
                    $not1 = "badge-warning";
                    $not2 = "Warning!";
                    $not3 = "Alamat Penerima Harus Diisi.";
                    $not4 = "index.php?page=keluar-tambah";
                    $not5 = "";
                    $not6 = "Kembali";
                    $not7 = "alert-warning";
    ...
    else
  {
    if(empty($keterangan))
    {
        ...
        {
                $q = "SELECT max(id) as maxId FROM surat_keluar";
                ...
                $sql = mysqli_query($db, $query);
                 if($sql)
                 {
                    ...
                    $not4 = "index.php?page=keluar-read";
                    $not5 = "";
                    $not6 = "Lihat Hasil";
                    $not7 = "alert-success";
                    notif($not7,$not1,$not2,$not3,$not4,$not5,$not6);
...
else
{
                    $not1 = "badge-danger";
                    $not2 = "Gagal!";
                    $not3 = "Maaf Anda Sebelumnya Harus Mengakses Halaman Ini Pada Form Tambah Data.";
                    $not4 = "index.php";
                    $not5 = "";
                    $not6 = "Kembali";
                    $not7 = "alert-danger";

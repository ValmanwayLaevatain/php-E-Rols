...
<?php
if (isset($_GET['id']) AND isset($_POST['no_surat']) AND isset($_POST['t_surat']) AND isset($_POST['perihal']) AND isset($_POST['isi_surat']) AND isset($_POST['alamat_tujuan']) AND isset($_POST['waktu']) AND isset($_POST['tempat']) AND isset($_POST['lampiran']) AND isset($_POST['keterangan']))
{
    include "../koneksi.php";
      ...
      if(empty($no_surat))
  {
    ?>
                ...
                <form action="index.php?page=keluar-edit" method="post" enctype="multipart/form-data" class="form-horizontal">    
  ...
  {
    if(empty($alamat_tujuan))
    {
      ?>

                <div class="col-sm-12">
                <div class="alert  alert-warning alert-dismissible fade show" role="alert">
                  <span class="badge badge-pill badge-warning">Warning!</span> Penerima Harus Diisi.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
      ...
      ?>
          ...
          else
          {
            ...
            if($num > 0)
            {
              ...
              {
                    $query = "INSERT INTO surat_keluar (id,t_surat,no_surat,perihal,isi_surat,alamat_tujuan,waktu,tempat,lampiran,keterangan,user) VALUES ('$id','$t_surat','$no_surat','$perihal','$isi_surat','$alamat_tujuan','$waktu','$tempat','$lampiran','$keterangan','$user')";
              }
...
else
{
  ?>
        <div class="col-sm-12">
                <div class="alert  alert-danger alert-dismissible fade show" role="alert">
                  <span class="badge badge-pill badge-danger">Gagal!</span> Maaf Anda Sebelumnya Harus Mengakses Halaman Ini Pada Form Edit Data.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
